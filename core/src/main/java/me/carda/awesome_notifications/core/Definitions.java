...
public interface Definitions {
    ...
    String NOTIFICATION_REQUEST_PROMOTED_ONGOING = "requestPromotedOngoing";
    String NOTIFICATION_SHORT_CRITICAL_TEXT = "shortCriticalText";
    ...
    Map<String, Object> initialValues = new HashMap<String, Object>(){{
        ...
        put(Definitions.NOTIFICATION_REQUEST_PROMOTED_ONGOING, false);
